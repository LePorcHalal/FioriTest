sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/beyondtechnologies/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#WRICEFEstimates-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#WRICEFEstimates-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.beyondtechnologies.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["com/beyondtechnologies/localService/mockserver"], function(mockserver) {
